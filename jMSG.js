var jMSG = {
	...
	, getBTN: function() {
		...
		img.src = this.MURL+"img/msg2.png";
		img.width = "30";
	...
	, setMBD: function() {
		...
		this.dvmsg.style.width = "310px";
		this.dvmsg.style.height = "500px";
		this.dvmsg.style.padding = "2px";
		this.dvmsg.style.boxShadow = "0 0 20px rgba(0,0,0,0.5)";
		this.dvmsg.style.zIndex = "999999";
		//Мәтін
		var url = this.VOURL+"show";
		//alert(url);
		this.a(url, '');
		//
		//this.dvmsg.innerHTML = this.show();
		/*this.c = "seturl";
		//alert(this.up+this.c);
		this.a(this.up+this.c, 'url='+this.url+'&msgcolor='+this.msgcolor);
